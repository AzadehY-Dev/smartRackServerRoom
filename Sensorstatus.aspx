...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <Columns>
        ...
        <custombuttons>
            ...
            <dx:GridViewCommandColumnCustomButton 
            ID="erase"><image tooltip="Alarm fixed" 
        ...
        <dx:GridViewDataTextColumn FieldName="unitS" Caption="Unit of Sensor" VisibleIndex="12">
               ...
               <dx:GridViewDataTextColumn FieldName="port" Caption="pin number" VisibleIndex="14">
        </dx:GridViewDataTextColumn>
          <dx:GridViewDataTextColumn FieldName="chart" Visible="false" VisibleIndex="15">
        </dx:GridViewDataTextColumn>
    </Columns>
   </dx:ASPxGridView>
           <br />
    ...
    <asp:Panel ID="pnlchart" runat="server" Visible="true">
        <dx:WebChartControl ID="WebChartControl3" runat="server" 
            CrosshairEnabled="True" DataSourceID="SqlDataSource1" Height="500px" Width="900px"></dx:WebChartControl>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ngDBConnectionString %>" 
            SelectCommand="select idSd,idDevice,[Date], Mount from [tblStatusSensorDevice]">
        </asp:SqlDataSource>
        <br />
        <dx:ASPxButton ID="btnback" runat="server" Text="Go Back" OnClick="btnback_Click" 
            Theme="Moderno"></dx:ASPxButton>
    </asp:Panel> 
    <asp:Label ID="lblsensor" runat="server" Text="Label" Visible="false"></asp:Label>
</asp:Content>
